...
void doSprite() {
  ...
  if(spriteIncrement == 19) {         //If on the final sprite, restart with the first sprite && Adjusted to 19 for new pokeball image
    spriteIncrement = 0;  
  }
}
////////////////////////////////////////////////////////////////////////////////////////////////
...
void selectSprite() {
  ...
  if(spriteNumberInt == 0) {          //If the sprite selection is 0, continue rotating through the different sprites
    ...
    if(spriteIncrement == 19) { //Adjust to 19 for new pokeball image
      spriteIncrement = 0;
    }
  }
